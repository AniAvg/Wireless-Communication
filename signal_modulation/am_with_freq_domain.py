...
plt.subplot(3, 1, 1)
plt.plot(freq_m[0:len(m_t)//2], magnitude_m[0:len(m_t)//2])
...
plt.subplot(3, 1, 2)
plt.plot(freq_c[0:len(c_t)//2], magnitude_c[0:len(c_t)//2])
...
plt.subplot(3, 1, 3)
plt.plot(freq_s[0:len(s_t)//2], magnitude_s[0:len(s_t)//2])
